...
export function ModalDelete(props: IModal) {
  return (
      <div className={styles.confirmBack}>
        <div className={styles.confirmBlock}>
          <button onClick={props.clickClose} className={styles.closeModal}>
          ...
          <button className={styles.btnConfirm} onClick={props.clickDelete}>Удалить</button>
